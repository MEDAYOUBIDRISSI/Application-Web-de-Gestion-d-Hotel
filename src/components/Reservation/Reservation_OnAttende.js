...
class Reservation_OnAttende extends Component {
    state = {
        books: [],
        editBookData: {
          id: '',
      ...
      _refreshBooks() {
        axios.get('http://localhost:8000/api/reseravtion/client/onattende').then((response) => {
    ...
    render(){
        ...
        let books = this.state.books.map((book) => {
            return (
                ...
                <td class="fc-list-item-time " style={{width:300}}>
                                ...
                                <ModalBody>
                                    <FormGroup>
                                        ...
                                        <select class="multiselect-dropdown form-control" id="etat" value={this.state.editBookData.etat} onChange={(e) => {
                                            ...
                                            <option value="1">Accepter La Reservation</option>
...
export default Reservation_OnAttende;
