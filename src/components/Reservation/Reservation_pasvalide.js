...
class Reservation_pasvalide extends Component {
    state = {
        books: [],
        editBookData: {
          id: '',
      ...
      _refreshBooks() {
        axios.get('http://localhost:8000/api/reseravtion/client/pasvalide').then((response) => {
...
export default Reservation_pasvalide;
